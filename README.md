...
- **New trip** — a top-nav button (folded into the mobile More sheet) starts a blank, unshared trip without touching the one you're in: a shared trip stays exactly as it is at its own link, this browser just detaches and opens the same blank page a bare visit to the site would. One Undo away if it was pressed by mistake.
